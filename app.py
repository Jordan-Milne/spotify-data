...
def index():
    ...
    items = [('Dreamville', 'Sacrifices (with EARTHGANG & J. Cole feat. Smino & Saba)', 0.001),
    ('Famous Dex', 'PICK IT UP (feat. A$AP Rocky)', 0.002),
    ('J. Cole', 'G.O.M.D.', 0.003),
    ('Kendrick Lamar', 'X (with 2 Chainz & Saudi)', 0.004),
    ('N.E.R.D', 'Lemon (feat. Drake) - Drake Remix', 0.004)]
